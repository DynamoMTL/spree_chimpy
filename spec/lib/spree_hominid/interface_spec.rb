...
describe SpreeHominid::Interface do
  ...
  it "can add an order" do
    ...
    lines = [OpenStruct.new(variant: variant, quantity: 2)]
    order = OpenStruct.new(id: 123, email: 'user@example.com', total: 100, completed_at: Date.new(2015, 1, 1), tax_total: 0.50, ship_total: 1.50, line_items: lines)
    expected = {
      id: 123,
      email_id: nil,
      ...
      :items=>[{product_id: 10, sku: "WDG-22", product_name: "Widget", cost: 10, qty: 2}]
    }
