...
describe Spree::Chimpy do
  ...
  context "enabled" do
    before do
      Spree::Chimpy::Interface::List.should_receive(:new).any_number_of_times.with('1234', 'Members', 'Customers', false).and_return(:list)
  ...
  context "sync merge vars" do
    ...
    before do
      Spree::Chimpy::Interface::List.should_receive(:new).any_number_of_times.with('1234', 'Members', 'Customers', false).and_return(interface)
      config(key: '1234',
             list_name: 'Members',
