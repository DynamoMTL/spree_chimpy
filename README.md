...
- Migration: A handy rake task `rake spree_chimpy:orders:sync` is included to sync up all your existing order data with mail chimp. You should run this after installing in an existing store.
